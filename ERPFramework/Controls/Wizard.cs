...
namespace ERPFramework.Controls
{
    ...
    public class Wizard : MetroFramework.Controls.MetroUserControl
    {
        #region Consts

        private const int FOOTER_AREA_HEIGHT = 48;
        private readonly Point offsetCancel = new Point(84, 36);
        private readonly Point offsetNext = new Point(180, 36);
        private readonly Point offsetBack = new Point(270, 36);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            PointF lF = new PointF(bottomRect.Left + 10, bottomRect.Y);
            PointF rF = new PointF(bottomRect.Right - 10, bottomRect.Y);
            e.Graphics.DrawLine(new Pen(Color.FromArgb(125, 152, 193)), lF, rF);
